...
const EditPromotion = () => {
  ...
  useEffect(() => {
    // Lấy thông tin khuyến mãi từ API
    setLoading(true);
    fetchPromotionDetail(proID)
      .then(response => {
        ...
        form.setFieldsValue({
          ...
          discountQuantity: promotion.discount,
...
>
  <RangePicker 
    ...
    style={{ width: '100%' }} 
    inputReadOnly // Ngăn không cho nhập trực tiếp vào trường
    onFocus={() => form.setFieldsValue({ dateRange: null })} // Clear giá trị khi bấm vào
  />
</Form.Item>
